...
![](../img/slides/pois1.png)

![](../img/slides/pois2.png)
...
-   It could also be negative binomial, zero-inflated, etc... but in this case it is Poisson!
...
::: notes
TALK ABOUT dispersion here!!!!!
:::

## What if this happens?

![](../img/slides/predicted.png)
...
```{r}
#| echo: true
dat<-read.csv("../data/parasitecod.csv")

...
-   Next topic: Data wrangling

-   We will also talk about "Generalized Mixed effects Models", which combine mixed effects and generalized linear models
...
A true Poisson distribution is completely random!!! But if you are counting animals, are individuals randomly distributed in a field?
...
-   Parasite counts, an example from the current assignment; most individuals have 0, but then some have hundreds!

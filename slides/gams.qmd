...
-   We use a term $\lambda$ to penalize for wiggliness. There are many ways to estimate it... but what is important is that we are **NOT TRYING TO MINIMIZE residuals!**

-   More knots potentially means more ‘wiggliness’

![](../img/slides/knot2.png)
...
-   EDF close to 1, close to a linear term, so it is probably better to run a linear model!
...
![](../img/slides/gaminfo.png)

## Assignment

There is a GAM assignment that goes with this material.

## Announcements

Sorry about the grading!

I appreciate your patience with grading and feedback.

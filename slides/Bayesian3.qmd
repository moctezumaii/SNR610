...
3. **Student A:** checks the new height (likelihood) and compares it to the current.
If new height > current, move 3 steps in that direction (Student B: write down the new x, student A write Likelihood)
If not, move only 1 step. Write down the new x and Likelihood as well.

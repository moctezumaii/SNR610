...
-   Gives us a posterior, based on a prior and a Likelihood; it models a probability. It is obtained by the product of:
...
-   Bayesian integrates a posterior, so there is no closed solution!
...
-   Practice plotting posterior, prior, and likelihood curves

-   Work through one Bayesian example from start to finish

-   Compare a Bayesian answer with a frequentist answer

-   Think about how this connects to multivariate models and later course topics

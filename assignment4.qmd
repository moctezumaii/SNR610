...
We will start using some methods that use Likelihood. At this point you should be able to understand the difference between likelihood and probability, even if you cannot fully describe it yet. If you find yourself using (or interested in using) Likelihood and Maximum Likelihood Methods, do yourself a favor and download the book by [Burnham and Anderson: Model Selection and Multimodel Inference. Which is free to download through the University of Tennessee Libraries!](https://link.springer.com/book/10.1007/b97636) [@burnham2010] It is the most useful book for multi-model inference!

I recommend the following paper: [@tredennick2021] [available here!](https://esajournals.onlinelibrary.wiley.com/doi/10.1002/ecy.3336)
...
::: callout-note
We will return to Likelihood later. The difference between Likelihood and Probability is worth revisiting a few times.
:::
...
Likelihood theory is a paradigm underlying both frequentist and Bayesian statistics, and you need to understand it if you ever want to go deeper into data science and data analyses. This is similar to the example discussed earlier.
...
What makes a model "better"? Start thinking about it
:::
...
Is a higher $r^2$ always better? When is it not better?
:::
...
The point is, you are testing your model in data that was not used to develop the model. Does that make sense? If not, pause here and ask for clarification. :)

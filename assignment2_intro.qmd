...
This is a longer assignment. You can take as long as you need on it 😃

You can download the Quarto document and use it to answer the questions, copy code, modify code, and so on.
...
Make sure you download the data file, and also save the Quarto file you're working on in the project folder!
:::

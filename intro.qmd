...
::: callout-note
If you have taken a similar introductory statistics course before, some of the activities and assignments in the first few sections may seem familiar. That is OK. Take this as a chance to reinforce the knowledge before moving into different topics.
:::

## Welcome

::: callout-important
If you are reading this file on your own, it may not make a lot of sense at first. That's OK. We will work through the material together, and you will learn more about R as you go.
:::

Before we get into the weeds of data analysis, coding, and R, we should remember some basics. If you have a lot of experience in R, just hang in there, we will get into more complex topics as we go. If you're brand new, also hang in there, this may seem overwhelming and very time consuming. It will get easier.
...
We will learn more about projects as we go. For the time being, let's do the following:
...
3.  Download the SNR610_W1_notes.qmd and the .csv files into the newly created project directory

::: callout-important
If you are working on this as a reference exercise, you can stop here for now
:::

### Statistics refresher

Open R and make sure the SNR 610 project is open. Then open the SNR610_W1_notes.qmd file in R and continue there.

First, we will discuss some topics.
...
![The three types of Butterflies that we have data on.](img/assignment1/butterflies.png)
...
Note that this data is a bit messy. We will learn how to clean data later in the book, but this is closer to what your data will look like initially!
...
Continue practicing R, projects, and Quarto.

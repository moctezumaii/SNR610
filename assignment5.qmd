...
We went through the Poisson example earlier. You can also access the presentation file and all of the code we used. During this assignment we will focus on the following:
...
Finally, let's think of the odds of me (Alejandro) seeing a car accident during my daily drive to and from campus). I know this is biased, and my very biased estimate says the probability is 0.8 (80% chance of seeing one). If this was true, then the odds would be:

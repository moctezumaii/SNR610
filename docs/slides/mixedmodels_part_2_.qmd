...
Mixed Effects Models lab, one lab session

Next topic: Generalized Mixed Effects Models

Suggested follow-up: work on your plot

## Back to our example

![](../img/mixed/map.png){width="416"}
...
-   mixed intercept, nets only affect the intercept; analogous to an additive model:
...
::: notes
Size is continuous, so it has a slope; region is categorical
:::
...
-   Random intercept, random slope, both? We will return to this choice later.
